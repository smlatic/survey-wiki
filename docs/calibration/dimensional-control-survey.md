---
title: Dimensional Control Survey on Vessels
category: calibration
tags: [dimensional control, lever arm, offsets, total station, photogrammetry, vessel survey]
equipment: [Total Station, Calibrated Steel Tape, Photogrammetry System]
...
### Step 5: Survey Method

- Primary instrument is a total station
- Multiple setups required to survey all points of interest
- All observations calculated into one common coordinate system using fixed points
- Every angle and distance measurement shall be surveyed at least twice
- All measurements must allow verification of survey accuracy
